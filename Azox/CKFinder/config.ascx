...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = VirtualPathUtility.ToAbsolute("~/Content/");
        ...
        Thumbnails.Url = BaseUrl + "Thumbnails/";
		if ( BaseDir != "" ) {
            Thumbnails.Dir = BaseDir + "Thumbnails/";
		}
		Thumbnails.Enabled = true;
		Thumbnails.DirectAccess = false;
		Thumbnails.MaxWidth = 160;
		Thumbnails.MaxHeight = 160;
