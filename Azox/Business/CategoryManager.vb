...
Public Class CategoryManager
    ...
    Public Overrides Async Function CreateAsync(entity As Category) As Task(Of Soldata.Azox.ManagerResult)
        entity.Path = Await CreatePathAsync(entity)
        Return Await MyBase.CreateAsync(entity)
    End Function

    Public Overrides Async Function UpdateAsync(entity As Category) As Task(Of Soldata.Azox.ManagerResult)
        entity.Path = Await CreatePathAsync(entity)
        Return Await MyBase.UpdateAsync(entity)
    End Function

    Public Overrides Async Function UpdateRangeAsync(entities As IEnumerable(Of Category)) As Task(Of Soldata.Azox.ManagerResult)
    ...
    Public Overrides Async Function DeleteAsync(entity As Category) As Task(Of Soldata.Azox.ManagerResult)
    ...
    Public Overrides Async Function DeleteRangeAsync(entities As IEnumerable(Of Category)) As Task(Of Soldata.Azox.ManagerResult)
        For Each item In entities
