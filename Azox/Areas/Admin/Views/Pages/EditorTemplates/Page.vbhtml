...
<div class="tab-content">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    @Html.LabelFor(Function(model) model.AbsolutePath, htmlAttributes:=New With {.class = "control-label required"})
                    @Html.ValidationMessageFor(Function(model) model.AbsolutePath, "", New With {.class = "text-danger"})
                    @Html.EditorFor(Function(model) model.AbsolutePath, New With {.htmlAttributes = New With {.class = "form-control", .placeholder = "/example/path"}})
                </div>
            </div>
        </div>
    </div>
