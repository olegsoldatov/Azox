...
Namespace Controllers
	...
	Public Class ManageController
		...
		Sub New(manager As ApplicationUserManager)
			UserManager = manager
		End Sub
		...
		Function Index(message As ManageMessageId?) As ActionResult
		...
		Function RemoveLogin() As ActionResult
		...
		Async Function ManageLogins(message As System.Nullable(Of ManageMessageId)) As Task(Of ActionResult)
