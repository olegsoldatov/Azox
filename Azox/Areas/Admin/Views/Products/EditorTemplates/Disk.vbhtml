...
<div class="tab-content">
	...
	<div class="tab-pane" id="feature" role="tabpanel" aria-labelledby="feature-tab">
		<div class="row">
			...
			<div class="form-group col-md-3">
				@Html.LabelFor(Function(model) model.BoltCount, htmlAttributes:=New With {.class = "control-label required"})
				@Html.ValidationMessageFor(Function(model) model.BoltCount, "", New With {.class = "text-danger"})
				@Html.EditorFor(Function(model) model.BoltCount, New With {.htmlAttributes = New With {.class = "form-control"}})
			</div>
			<div class="form-group col-md-3">
				@Html.LabelFor(Function(model) model.BoltSpacing, htmlAttributes:=New With {.class = "control-label"})
				@Html.ValidationMessageFor(Function(model) model.BoltSpacing, "", New With {.class = "text-danger"})
				@Html.EditorFor(Function(model) model.BoltSpacing, New With {.htmlAttributes = New With {.class = "form-control"}})
			</div>
			<div class="form-group col-md-3">
				@Html.LabelFor(Function(model) model.BoltSpacing2, htmlAttributes:=New With {.class = "control-label"})
				@Html.ValidationMessageFor(Function(model) model.BoltSpacing2, "", New With {.class = "text-danger"})
				@Html.EditorFor(Function(model) model.BoltSpacing2, New With {.htmlAttributes = New With {.class = "form-control"}})
			</div>
			<div class="form-group col-md-3">
				@Html.LabelFor(Function(model) model.Et, htmlAttributes:=New With {.class = "control-label"})
				@Html.ValidationMessageFor(Function(model) model.Et, "", New With {.class = "text-danger"})
				@Html.EditorFor(Function(model) model.Et, New With {.htmlAttributes = New With {.class = "form-control"}})
			</div>
			<div class="form-group col-md-3">
				@Html.LabelFor(Function(model) model.Dia, htmlAttributes:=New With {.class = "control-label"})
				@Html.ValidationMessageFor(Function(model) model.Dia, "", New With {.class = "text-danger"})
				@Html.EditorFor(Function(model) model.Dia, New With {.htmlAttributes = New With {.class = "form-control"}})
			</div>
			<div class="form-group col-md-3">
				@Html.LabelFor(Function(model) model.Color, htmlAttributes:=New With {.class = "control-label"})
