...
Public NotInheritable Class ImageUtility
    ...
    Public Shared Function ToBytes(fileName As String, args As ImageUtilityArgs) As Byte()
        ...
        Return ImageToBytes(Image.FromFile(fileName), format, args.Width, args.Height, args.TransformMode, args.BackgroundColor)
    End Function
    ...
    Public Shared Function ToBytes(postedFile As HttpPostedFileBase, args As ImageUtilityArgs) As Byte()
        ...
        Return ImageToBytes(Image.FromStream(postedFile.InputStream, True, True), format, args.Width, args.Height, args.TransformMode, args.BackgroundColor)
    End Function
