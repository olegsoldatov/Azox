...
#Region " Навигация "
    ...
    <Extension()>
    Public Function Navs(helper As HtmlHelper, ParamArray excludedUrls() As String) As MvcHtmlString
    ...
    ''' <returns>Объект <see cref="MvcHtmlString" />.</returns>
    <Extension()>
    Public Function Navs(helper As HtmlHelper, htmlAttributes As Object, ParamArray excludedUrls() As String) As MvcHtmlString
    ...
    ''' <returns>Объект <see cref="MvcHtmlString" />.</returns>
    <Extension()>
    Public Function Navs(helper As HtmlHelper, childLevels As Integer, ParamArray excludedUrls() As String) As MvcHtmlString
    ...
    ''' <returns>Объект <see cref="MvcHtmlString" />.</returns>
    <Extension()>
    Public Function Navs(helper As HtmlHelper, childLevels As Integer, htmlAttributes As Object, ParamArray excludedUrls() As String) As MvcHtmlString
    ...
    ''' <returns>Объект <see cref="MvcHtmlString" />.</returns>
    <Extension()>
    Public Function Navs(helper As HtmlHelper, childLevels As Integer, useDropDown As Boolean, htmlAttributes As Object, ParamArray excludedUrls() As String) As MvcHtmlString
